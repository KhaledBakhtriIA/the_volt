...
from data_api.jobs import run_production
...
def test_run_production_runs_collection_only(monkeypatch):
    ...
    with patch("data_api.jobs.run_production.run_once_main") as mock_run_once:
        with patch("data_api.jobs.run_production.prepare_kaggle_main") as mock_kaggle:
            run_production.main()
